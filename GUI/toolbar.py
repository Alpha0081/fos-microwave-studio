...
class ToolBar(QMainWindow):
    def __init__(self, parent):
        ...
        FarfieldAnalyzer = QAction('Import Farfield', parent)
        FarfieldAnalyzer.setStatusTip('Import Farfield')
        FarfieldAnalyzer.triggered.connect(parent.analyze_farfield)
        
        menubar = parent.menuBar()
        filemenu = menubar.addMenu('&File')
        filemenu.addAction(openFile)
        filemenu.addAction(saveFile)
        filemenu.addAction(FarfieldAnalyzer)
