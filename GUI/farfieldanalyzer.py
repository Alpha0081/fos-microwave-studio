...
class FarfieldAnalyzer(QWidget):
    def __init__(self, parent, name):
        ...
        btnsave.clicked.connect(self._save_button_clicked)
        
        btn = QPushButton('Analyze', self)
        btn.resize(93, 28)
        btn.move(620, 470)
        btn.setFont(QFont(font, 12))
        btn.clicked.connect(self._analyze_button_clicked)        
    ...
    def _save_button_clicked(self):
        ...
        if fileName:
            pass
        fileName, _ = QFileDialog.getSaveFileName(self, '',"3DGUI.png", '*.png')
        if fileName:
            pass
